        ...
        foreach ($data as $value) {
            ...
            foreach ($value['producto'] as $v) {
                ...
                if ($v['Factura'] != '') {
                    ...
                    if (!isset($t_facturas[$nro_factura]))
                    {
                        $t_facturas[$nro_factura] = 0;
                    }
                    ...
                    if (!isset($ivas_facturas[$nro_factura]))
                    {
                        $ivas_facturas[$nro_factura] = 0;
                    }
            ...
            foreach ($productos as $value) {
                ...
                foreach ($value['producto'] as $v) {
                    ...
                    if ($v['Factura']) {
                        ...
                        if (!isset($facturas[$v['Factura']])) {
                            // Si la factura no existe, inicializar sus valores en 0
                            $facturas[$v['Factura']]['iva_19'] = 0;
                            $facturas[$v['Factura']]['iva_0'] = 0;
                        }
