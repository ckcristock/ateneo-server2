<?php
namespace App\Http\Services\comprobantes;

use App\Http\Services\consulta;
use App\Http\Services\complex;

class ObtenerProximoConsecutivo
{
    public static function obtener($tipo, $company = 1, $mes = null, $anio = null, $dia = null)
    {
    ...
    public static function generarConsecutivo($tipo, $mes = null, $anio = null)
    {
        $mes = $mes === null ? date('m') : $mes;
    ...
    public static function generarConsecutivoCheque($banco)
    {
        $status = 0;
        $consecutivo = '';
