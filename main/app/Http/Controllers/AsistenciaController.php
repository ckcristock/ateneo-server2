...
class AsistenciaController extends Controller
{
                    ...
                    if (key_exists('candidates', $resp[0]) && count($res) > 0) {
                        ...
                        if (count($candidatos) > 0) {
                            ...
                            if ($candidato != '') {
                                ...
                                $funcionario = PersonService::funcionarioTurno($candidato, $dias[date("w", strtotime($hoy))], $hoy, $ayer);
    ...
    public function responseAccesoInstantaneo($func): array
    {
        $respuesta = array(
            ...
            'html' => "<img src='" .
                $func->image . "' class='img-thumbnail rounded-circle img-fluid' style='max-width:140px;'  /><br><strong>Acabas de ingresar, Espera unos minutos </strong><br><strong>" .
                $func->nombres . " " .
                $func->apellidos . "</strong>",
            'icon' => 'warning'
        );
        return $respuesta;
    }
            ...
            if (isset($func->contractultimate->fixedTurn->horariosTurnoFijo[0])) {
                ...
                if ($diff <= $tol_ent) {
                    ...
                    $respuesta = array(
                        ...
                        'html' => "<img src='" .
                            $func->image . "' class='img-thumbnail rounded-circle img-fluid' style='max-width:140px;'  /><br><strong>Bienvenido, Hoy ha llegado temprano</strong><br><strong>" .
                            $func->nombres . " " .
                            $func->apellidos . "</strong><br>" .
                    ...
                    $respuesta = array(
                        'title' => 'Acceso Autorizado',
                        'html' => "<img src='" .
                            $func->image . "' class='img-thumbnail rounded-circle img-fluid' style='max-width:140px;'  /><br><strong>Bienvenido</strong><br><strong>" .
                            $func->nombres . " " .
                            $func->apellidos . "</strong><br><strong style='color:red;'>" .
                            $lleg . "</strong><br>" . date("d/m/Y H:i:s", strtotime($hoy . " " . $hactual)),
                        'icon' => 'success'
                    );
                    return $respuesta;
                }
    ...
    private function ValidaTurnoLibre($func, $hoy, $hactual, $fully, $temperatura, $empresa)
    {
        return "Turno Libre";
    }
