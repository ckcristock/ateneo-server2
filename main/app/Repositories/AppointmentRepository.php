...
class AppointmentRepository
{
    ...
    public static function pending()
    {
        return DB::table('appointments')
            ...
            ->when(Request()->has('date') && Request()->get('date') != 'null', function ($query) {
                $startOfDay = Carbon::parse(Request()->get('space_date'))->startOfDay();
                $endOfDay = Carbon::parse(Request()->get('space_date'))->endOfDay();
    ...
    public static function recurrent()
    {
        ...
        for ($day = $dateStart; $day <= $dateEnd; $day->addDay()) {
