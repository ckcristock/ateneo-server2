...
$config['thumbs_base_path'] .= $_GET['car'] . '/'; 
$config['thumbs_upload_dir'] .= $_GET['car'] . '/'; 
$config['ftp_thumbs_dir'] .= $_GET['car'] . '/'; 
	...
	<div class="span12">
        ...
        foreach ($files as $file_array) {
            ...
            <?php }else{ ?>
                    ...
                    <figcaption>
                        <a href="javascript:void('')" class="tip-left edit-button rename-file-paths <?php if($config['rename_folders'] && !$file_prevent_rename) echo "rename-folder";?>" title="<?php echo trans('Rename')?>" data-path="<?php echo $_GET['car']. '/' . $rfm_subfolder . $subdir . $file; ?>" data-thumb="<?php echo $thumbs_path . $subdir . $file; ?>" data-folder="1" data-permissions="<?php echo $file_array['permissions']; ?>">
                        <i class="icon-pencil <?php if(!$config['rename_folders'] || $file_prevent_rename) echo 'icon-white';?>"></i></a>
                        <a href="javascript:void('')" class="tip-left erase-button <?php if($config['delete_folders'] && !$file_prevent_delete) echo "delete-folder";?>" title="<?php echo trans('Erase')?>" data-confirm="<?php echo trans('Confirm_Folder_del');?>" data-path="<?php echo $_GET['car']. '/' . $rfm_subfolder . $subdir . $file; ?>" data-thumb="<?php echo $thumbs_path . $subdir . $file; ?>" >
            ...
            <?php if($config['multiple_selection']){ ?><div class="selector">
                ...
                <figcaption>
                            ...
                            echo $nu; ?>">
                                ...
                                if($_GET['car'] != ''){
                                    echo $_GET['car'] . '/' . $rfm_subfolder . $subdir;
                                } else {
                                ...
                                <?php
                                    ...
                                    if ($is_audio) {
                                       ...
                                       echo $_GET['car']. '/' . $rfm_subfolder . $subdir . $file; ?>"
