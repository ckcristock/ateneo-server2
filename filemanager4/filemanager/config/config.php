...
$config = array(
    ...
    */
    ...
    //'upload_dir' => '../../DOCUMENTOS/' . $_GET['car'] . '/', // path from base_url to base of upload folder (with start and final /)
    //'current_path' => '../../DOCUMENTOS/'. $_GET['car'] . '/', // relative path from filemanager folder to upload folder (with final /)
    //thumbs folder can't put inside upload folder
    //'thumbs_base_path' => '../thumbs/'. $_GET['car'] . '/', // relative path from filemanager fold
